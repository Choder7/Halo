...
def load_css() -> None:
    ...
    css = _twin_keyframes(CSS.replace("$PAGE_BG$", PAGE_BG),
...
class HaloWindow(Gtk.ApplicationWindow):
    ...
    def __init__(self, app: "HaloApp") -> None:
        ...
        self._page_bg = PAGE_BG       # what the page last told us it paints
    ...
    def show_popup(self, reposition: bool = True) -> None:
        ...
        if first_map:
            ...
            if reposition:
                ...
                # Back up exactly where it was: that is the anchor now.
                GLib.idle_add(lambda: (self._note_pill_y(), False)[1])
    ...
    def _on_remove_setup(self, *_a) -> None:
        ...
        dialog.add_response("cancel", "Cancel")
        dialog.add_response("keep", "Remove, keep my settings")
